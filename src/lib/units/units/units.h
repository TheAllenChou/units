...
#define BASIC_UNIT_EXTERNAL(UnitName, StorageType, LiteralSuffix)                                                               \
  ...
  const UnitName operator"" LiteralSuffix (long double data) { return UnitName::From(static_cast<UnitName::Storage>(data)); }   \
  const UnitName operator"" LiteralSuffix (std::size_t data) { return UnitName::From(static_cast<UnitName::Storage>(data)); }   \
...
#define DERIVED_UNIT_DIV_EXTERNAL(UnitName, LhsType, RhsType)                                                                   \
  const UnitName operator/(LhsType lhs, RhsType rhs) { return UnitName::From(lhs.GetRaw() / rhs.GetRaw()); }                    \
...
#define DERIVED_UNIT_MUL_EXTERNAL(UnitName, LhsType, RhsType)                                                                   \
  const UnitName operator*(LhsType lhs, RhsType rhs) { return UnitName::From(lhs.GetRaw() * rhs.GetRaw()); }                    \
  const UnitName operator*(RhsType rhs, LhsType lhs) { return UnitName::From(rhs.GetRaw() * lhs.GetRaw()); }                    \
